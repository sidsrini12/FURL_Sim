...
cnn(){
python viz/expt_4_distributed.py --baseline \
    ../ckpts/cifar_100/history/clf_cnn_optim_sgd_uniform_True_non_iid_10_num_workers_100_lr_0.001_decay_1e-05_batch_0_signsgd.pkl \
    ../ckpts/cifar_100/history/clf_cnn_optim_sgd_uniform_True_non_iid_3_num_workers_100_lr_0.001_decay_1e-05_batch_0_signsgd.pkl \
    --ours \
	../ckpts/cifar_100/history/clf_cnn_optim_sgd_uniform_True_non_iid_10_num_workers_100_lr_0.001_decay_1e-05_batch_0_signsgd_lbgm_0.6.pkl \
	../ckpts/cifar_100/history/clf_cnn_optim_sgd_uniform_True_non_iid_3_num_workers_100_lr_0.001_decay_1e-05_batch_0_signsgd_lbgm_0.8.pkl \
    --loss-type ce ce ce ce \
    --models CIFAR-10:IID/SignSGD CIFAR-10:Non-IID/SignSGD \
    --m-int 1e6 1e6 1e6 1e6 \
    --m-str 10^6 10^6 10^6 10^6 \
    --u-int 0 0 0 0 \
    --u-str na na na na \
    --ylim1 0.6 0.4 0.9 0.8 \
    --ylim2 45 45 45 45 \
    --dry-run $dry --final $final \
    --save ../ckpts/plots/expt_4_distributed_cnn
}
...
python viz/expt_4_distributed.py --baseline \
	...
	../ckpts/cifar_100/history/clf_cnn_optim_sgd_uniform_True_non_iid_3_num_workers_100_lr_0.0001_decay_1e-05_batch_0_signsgd_lbgm_0.8.pkl \
    --loss-type ce ce ce ce \
    --models CIFAR-10:IID/SignSGD CIFAR-10:Non-IID/SignSGD \
    --m-int 1e6 1e6 1e6 1e6 \
    --m-str 10^6 10^6 10^6 10^6 \
